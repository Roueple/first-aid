...
interface BernardAggregationChartProps {
  data: AggregationResult[];
  groupByField: string | string[];
  aggregationType?: string;
  onGroupClick?: (result: AggregationResult) => void;
}
...
export const BernardAggregationChart: React.FC<BernardAggregationChartProps> = ({
  data,
  groupByField,
  ...
  return (
    <div className="bernard-chart-container" data-tutorial="aggregation-chart">
      <div className="bernard-chart-header">
        <span className="bernard-chart-title">
          📊 {isMultiDimensional ? 'Multi-Dimensional ' : ''}Trend Analysis
        </span>
        <span className="bernard-chart-subtitle">
          {metricLabel} by {groupByDisplay}
        </span>
      </div>
      
      <div className="bernard-chart-wrapper bernard-chart-white-bg">
      ...
      {activeLine && seriesData.has(activeLine) && (
        <div className="bernard-chart-detail-panel">
          <div className="bernard-chart-detail-header">
          ...
          <div className="bernard-chart-detail-grid">
            {seriesData.get(activeLine)?.map((point) => (
              <div key={point.name} className="bernard-chart-detail-item">
                <span className="bernard-chart-detail-label">{point.name}</span>
                <span className="bernard-chart-detail-value">
          ...
          <div className="bernard-chart-detail-summary">
...
export default BernardAggregationChart;
