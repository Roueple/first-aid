      ...
      <div className="text-center max-w-2xl">
        ...
        <div className="mb-6 flex gap-3 justify-center flex-wrap">
          ...
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition font-semibold shadow-md"
          >
            📄 Doc Assistant
          </button>
          <button
            onClick={() => navigate('/felix')}
            className="bg-gradient-to-r from-blue-700 to-purple-700 text-white px-6 py-3 rounded-lg hover:from-blue-800 hover:to-purple-800 transition font-semibold shadow-lg"
          >
            🤖 Felix AI
          </button>
          <button
