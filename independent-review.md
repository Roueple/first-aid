  ...
  1. Desktop Application: Electron or Qt for Phase 1? Electron
  2. Excel Import: What are the actual column structures of the 173 files? basic findings list first, later we improve from there
  3. RAG Strategy: Which embedding model and chunk size? best one, pick one  
  4. Testing: Unit tests throughout or focused in Phase 4? focused in phase 4, i will test manually
  5. Deployment: Cloud hosting or on-premise? cloud hosting. In Firebase database.
